...
class Gem(Task):
    def __init__(self, package=None, version=None):
        """
        Installs a Ruby Gem to the local user's home directory (no sudo required). You will need
        to add ~/.gem/ruby/*/bin to your PATH in order for Gem bundled scripts to work.
